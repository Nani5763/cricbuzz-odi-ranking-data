...
for item in configs:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Create new file for each run/date, no append
            filename = f"{format_type}_{category}_rankings_{file_date}.csv"
        ...
        print(f"Request error for {category}-{format_type}: {e}")